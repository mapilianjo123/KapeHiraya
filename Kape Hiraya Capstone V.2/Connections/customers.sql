...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=87170972ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kapehiraya&table=customers">`kapehiraya`.`customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kapehiraya&table=Customers">`kapehiraya`.`Customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=eletronic_medical_records&table=patients">`eletronic_medical_records`.`patients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=eletronic_medical_records&table=users">`eletronic_medical_records`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=eletronic_medical_records&table=treatment">`eletronic_medical_records`.`treatment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=eletronic_medical_records&table=drugs">`eletronic_medical_records`.`drugs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=eletronic_medical_records&table=consultation">`eletronic_medical_records`.`consultation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=eletronic_medical_records&table=laboratory">`eletronic_medical_records`.`laboratory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=eletronic_medical_records&table=labresults">`eletronic_medical_records`.`labresults`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=eletronic_medical_records&table=tests">`eletronic_medical_records`.`tests`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="40417c6b372a32732e536846296b783a">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="kapehiraya" targettable="customers">
